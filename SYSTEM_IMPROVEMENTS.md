...
> **Generalized principles have been elevated to `~/.claude/rules/testing.md`** (behavioral testing mindset, anti-patterns, test review checklist, red flags, quality questions). This section retains only dotfiles-specific context.
...
> **Elevated to `~/.claude/rules/testing.md`**: Test quality checklist, red flags, and quality questions. See global rules for the canonical versions.
